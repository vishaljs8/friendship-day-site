...
export default function FinalMessageScreen() {
  ...
  const messages = [
  "Happy Friendship Day, baby! 💖",
  "I’m still thankful to God for making us friends in the very beginning...",
  "And for continuing our bond into something even deeper. 😊",
  "The start of this relationship would've been incomplete without friendship. 🫶",
  "I hope this friendship keeps growing stronger,",
  "So we can share *everything* without hesitation. 💬",
  "Even if we can’t talk like partners in tough times,",
  "We can still talk like best friends — and get through it together. 💪",
